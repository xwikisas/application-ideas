...
// It's assumed that Jenkins has been configured to implicitly load the vars/xwikisasModule.groovy library which exposes
// the "xwikisasModule" global function/DSL.
